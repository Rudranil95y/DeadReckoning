package appstrix.deadreckoning.activity;
...
import appstrix.deadreckoning.extra.ExtraFunctions;
import appstrix.deadreckoning.stepcounting.DynamicStepCounter;
import appstrix.deadreckoning.stepcounting.StaticStepCounter;
import nisargpatel.deadreckoning.R;

public class StepCountActivity extends Activity implements SensorEventListener{

    private final nisargpatel.deadreckoning.dialog.StepInfoDialogFragment myDialog = new StepInfoDialogFragment();
    ...
    public static class StepInfoDialogFragment extends nisargpatel.deadreckoning.dialog.StepInfoDialogFragment {
    }
}
