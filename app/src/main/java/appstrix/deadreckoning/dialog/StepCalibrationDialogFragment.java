...
import appstrix.deadreckoning.activity.StepCalibrationActivity;
...
public class StepCalibrationDialogFragment extends DialogFragment{
    ...
    public void setOnPreferredStepCounterListener(StepCalibrationActivity onPreferredStepCounterListener) {
