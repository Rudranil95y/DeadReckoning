package appstrix.deadreckoning.dialog;
import appstrix.deadreckoning.activity.*;
...
import appstrix.deadreckoning.interfaces.OnUserUpdateListener;
                ...
                .setNeutralButton("Stride Length Calc", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (checkInvalidUserName(userName)) {
                            ...
                            Intent myIntent = new Intent(context, StepCaliberationActivity);
